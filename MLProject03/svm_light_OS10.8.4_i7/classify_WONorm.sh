...
do
	# linear
	./svm_classify  ./svmipData/${rankAlgo}_FCount_${topN}_WONorm.svmvalid ./svmModels/${rankAlgo}_FCount_${topN}_WONorm.svmmodel ./svmTestResults/${rankAlgo}_FCount_${topN}_WONorm.svmresult
done
