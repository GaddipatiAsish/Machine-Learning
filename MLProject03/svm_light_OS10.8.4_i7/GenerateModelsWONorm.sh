...
rankAlgo=Pearson #S2Noise    #TTest    #"Pearson"
...
do
	# linear
	./svm_learn -t 0 -c 1 ./svmipData/${rankAlgo}_FCount_${topN}_WONorm.svmtrain ./svmModels/${rankAlgo}_FCount_${topN}_WONorm.svmmodel
done